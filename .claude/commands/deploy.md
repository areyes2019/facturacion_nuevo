...
Reporta el resultado tal cual. Si alguna comprobación falla, consulta la tabla
...
- Subir `frontend/dist/.htaccess` al docroot: pisaría el `.htaccess` de
  producción y tumbaría el enrutado hacia Laravel. Los scripts ya lo excluyen.
