...
/**
 * Solo aplica a facturas en estado `borrador`/`pendiente` (el controller valida el estado);
 * mismas reglas que la creación, ya que reintentar el timbrado reenvía el formulario completo.
 */
